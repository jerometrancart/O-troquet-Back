 ...
 */
final class Version20200623124736 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_friends_user (user_friends_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_808487B9A76ED395 (user_id), INDEX IDX_808487B9EEAD45DB (user_friends_id), PRIMARY KEY(user_friends_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
